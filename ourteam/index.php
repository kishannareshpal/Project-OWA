            ...
            <div style="margin-top: 30px" class="mdl-cell mdl-cell--10-col">
              ...
              <nav class="mdl-navigation mdl-shadow--2dp mdl-color--grey-50" style="padding: 20px; margin-bottom: 30px; border-radius: 5px">
                <div class="mdl-grid">
                  ...
                  <a href='#                ' style="color: white; margin: 5px; padding-top: 2px; border-radius: 7px; font-family: karma" class="mdl-button mdl-js-button mdl-color--green-500">Our Team</a>
              ...
              <h1 style="font-size: 40px; padding-left: 5px; text-shadow: 3px 3px rgba(180, 236, 192, 0.63);"><strong>Meet the Team</strong></h1>
              ...
              <div style="width: 100%; border-radius: 10px" class="mdl-card">
                <div style="width: 100%" class="mdl-card__supporting-text">
                  <h3 style="position: relative; left: 10px" class="mdl-color-text--green-500"><strong>Our Teachers</strong></h3>
                  ...
                  <div class="mdl-grid">
                    <div class="mdl-layout-spacer"></div>
                      ...
                      <div class="ui four stackable cards">
                        <div class="yellow mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/roque.jpg">
                          </div>
                          <div class="content">
                            <a class="header">Roque Diogo da Fonseca Malandela</a>
                            <div class="meta">
                              Since 2017
                            </div>
                          </div>
                          <div class="extra content mdl-color-text--grey-700">
                            <span style="font-size: 14px">
                              Director/4th Grade Teacher
                            </span>
                          </div>
                        </div>

                        <div class="pink mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/rita.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Rita Macane Tomberli</div>
                            <div class="meta">
                              Since 2015
                            </div>
                          </div>
                          <div class="extra content mdl-color-text--grey-700">
                            <span style="font-size: 14px">
                              Assistant Director/Kindergarten Teacher
                            </span>
                          </div>
                        </div>

                        <div class="red mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/irene.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Irene Anatásio Sinai</div>
                            <div class="meta">
                              Since 2015
                            </div>
                          </div>
                        ...
                        <div class="blue mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/moises.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Moisés da Silva Samuel</div>
                            <div class="meta">
                              Since 2018
                            </div>
                          </div>
                        ...
                        <div class="teal mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/amelia.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Amélia Moreira de Jesús Teresa</div>
                            <div class="meta">
                              Since 2017
                            </div>
                          </div>
                        ...
                        <div class="green mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/teodosio.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Teodósio Paulino Mutambe</div>
                            <div class="meta">
                              Since 2017
                            </div>
                          </div>
                        ...
                        <div class="purple mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/eric.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Eric Christian Cooper</div>
                            <div class="meta">
                              Since 2015
                            </div>
                          </div>
                          <div class="extra content mdl-color-text--grey-700">
                            <span style="font-size: 14px">
                               English Teacher for Kindergarten, 1st grade and 2nd grade
                            </span>
                          </div>
                        </div>

                        <div class="black mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/silvino.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Silvino Augusto Lambo</div>
                            <div class="meta">
                              Since 2018
                            </div>
                          </div>
                        ...
                        <div class="blue mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/alisa.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Alisa Cacho-Sousa</div>
                            <div class="meta">
                              Since 2017
                            </div>
                          </div>
                          <div class="extra content mdl-color-text--grey-700">
                            <span style="font-size: 14px">
                               English Teacher for 3rd grade and 4th grade
                            </span>
                          </div>
                        </div>
                        ...
                        <div class="yellow mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/agostinho.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Agostinho Álvaro Marengula Matsombe</div>
                            <div class="meta">
                              Since 2015
                            </div>
                          </div>
                        ...
                        <div class="brown mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/zito.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Zito Jorge Ngovene</div>
                            <div class="meta">
                              Since 2016
                            </div>
                          </div>
                        ...
                        <div class="black mdl-color--grey-50 card">
                          <div class="image">
                            <img src="profpic/elisa.jpg">
                          </div>
                          <div class="content">
                            <div class="header">Elisa Albano Massingue</div>
                            <div class="meta">
                          ...
                          <div class="extra content mdl-color-text--grey-700">
                            <span style="font-size: 14px">
                               Secretary/Kindergarten Assistant
                            </span>
                          </div>
                        </div>
        ...
        <footer id="footer" hidden style="text-align: center; font-family: karma" class="mdl-mega-footer mdl-color--grey-50">
          ...
          <div class="mdl-mega-footer__bottom-section">
            ...
            <div class="mdl-grid" style="padding: 0px; margin-bottom: 22px;"> <!-- position: relative; bottom: 17px -->
              <div class="mdl-layout-spacer"></div>
              <a href="http://pt.oneworldacademymz.com/ourteam/" class="mdl-button mdl-js-button mdl-color--grey-200" style="text-transform: none; font-family: 'Karma'; color: grey; padding-top: 2px; border-radius: 3px" tabindex="0">
