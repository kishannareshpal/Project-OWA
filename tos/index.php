  ...
  <head>
    ...
    <title>Terms and Conditions - OWA</title>
        ...
        <div class="mdl-grid" style="margin-bottom: 350px;">
          <div class="mdl-layout-spacer"></div>
            <div style="margin-top: 30px" class="mdl-cell mdl-cell--10-col">
              ...
              <h1 style="font-size: 40px; padding-left: 5px; text-shadow: 3px 3px rgba(180, 236, 192, 0.63);"><strong>Terms and Conditions</strong></h1>
                ...
                <div style="width: 100%" class="mdl-card__supporting-text">
                  <!-- actual page content -->
                    <div class="mdl-layout-spacer"></div>
                      ...
                      <p style="margin-top: 0px">These Terms and Conditions, together with the <a href="../privacy">Privacy Policy</a> (the “Privacy Policy”), constitute a legally binding agreement between One World Academy ("One World Academy") and you. In these Terms and Conditions, One World Academy is sometimes referred to as “we” or “us” or “our”.</p>
                      <br>

                      <h3 style="margin-bottom: 0px"><strong>Legally binding agreement</strong></h3>
                      <p style="margin-top: 0px; margin-bottom: 0px">By accessing the Website, you agree to be legally bound by these Terms and Conditions and the Privacy Policy.<br>One World Academy reserves the right to update these Terms and Conditions and the Privacy Policy at any time without prior notice. By continuing to access the Website, you will be legally bound by the then-current Terms and Conditions and Privacy Policy.</p>
        ...
        <footer id="footer" hidden style="text-align: center; font-family: karma" class="mdl-mega-footer mdl-color--grey-50">
          ...
          <div class="mdl-mega-footer__bottom-section">
            ...
            <div class="mdl-grid" style="padding: 0px; margin-bottom: 22px;"> <!-- position: relative; bottom: 17px -->
              <div class="mdl-layout-spacer"></div>
              <!-- <a href="http://pt.oneworldacademymz.com/getinvolved/" class="mdl-button mdl-js-button mdl-color--grey-200" style="text-transform: none; font-family: 'Karma'; color: grey; padding-top: 2px; border-radius: 3px" tabindex="0">
