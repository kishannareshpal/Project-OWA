      ...
      *, h1, h2, h3, h4, h5, h6{
        font-family: 'karma';
			...
			.mdim_back {
			  ...
			  background: url("../images/mdim_back.png") no-repeat center center fixed;
  ...
  <body class="mdl-color--grey-100">
            ...
            <div style="margin-top: 30px" class="mdl-cell mdl-cell--10-col">
              ...
              <div class="mdl-grid" style="margin-bottom: 10px;"> <!-- position: relative; bottom: 17px -->
                ...
                <div class="mdl-grid">
                  ...
                  <a href='#                ' style="color: white ; margin: 5px; padding-top: 2px; border-radius: 7px; font-family: karma"    class="mdl-button mdl-js-button mdl-color--green-500">Envolver-se</a>
              ...
              <h1 style="font-size: 40px; padding-left: 5px; text-shadow: 3px 3px rgba(180, 236, 192, 0.63);"><strong>Envolver-se</strong></h1>
                  ...
                  <!-- actual page content -->
                    <div class="mdl-layout-spacer"></div>
										<div style="margin: 5px">
											<h4><strong>Formas de se envolver a One World Academy</strong></h4>

											<div style="margin-top: 10px" class="ui one stackable cards">
												<div class="ui teal card">
												  <div class="content">
														<div style="margin-top: 20px" class="header">Doações</div>
												    ...
												    <div class="description" style="line-height: 1.8">
															...
															<br><br>
															Estamos extremamente gratos que o centro de caridade baseada em Texas,  <i><strong>MDiM</strong></i> (<strong>Mozambique Development in Motion</strong>), nos permite usar sua isenção de impostos <strong>501(c)(3)</strong> para o estatuto de caridade dos doadores para receber doações.
															Para doar simplesmente clique no butão Doar abaixo (ou visite <a target="_blank" class="mdl-color-text--teal" href="https://www.mdim.org">https://www.mdim.org</a>) e siga as instrucões. Não esqueça de mencionar que você quer que a doação vá para o One World Academy :)
												    </div>
												  </div>
												...
												<div class="ui yellow card">
												  <div class="content">
														<div style="margin-top: 20px" class="header">Junte-se a Equipe!</div>
												    <div class="meta"><br></div>
												    <div class="description" style="line-height: 1.8">
															<img style="border-radius: 10px" width="100%" src="../images/joinus.png">
															<br><br>
															Procuramos pessoas e organizações do estrangeiro para nos ajudar a angariar fundos, desenvolver projetos e a crescer! Envie-nos um <a href="mailto:oneworldacademymz@gmail.com"><u>Email</u></a> e avise-nos que desejas te envolver :)
												    </div>
												  </div>
												  <div class="extra content">
												...
												<div class="ui green card">
												  <div class="content">
														<div style="margin-top: 20px" class="header">Seja um professor voluntário!</div>
												    <div class="meta"><br></div>
												    <div class="description" style="line-height: 1.8">
															<img style="border-radius: 10px" width="100%" src="../images/volunteer.png">
															<br><br>
															Quer vir para o belo Moçambique e passar algum tempo trabalhando com crianças fantásticas? Envie-nos um <a href="mailto:oneworldacademymz@gmail.com"><u>Email</u></a> e podemos providenciar uma ótima estadia!
												    </div>
												  </div>
												  <div class="extra content">
        ...
        <footer id="footer" hidden style="text-align: center; font-family: karma" class="mdl-mega-footer mdl-color--grey-50">
          ...
          <div class="mdl-mega-footer__bottom-section">
            <div class="mdl-layout-spacer"></div>
              ...
              <div class="mdl-layout-spacer"></div>
              <a href="https://www.oneworldacademymz.com/getinvolved/" class="mdl-button mdl-js-button mdl-color--grey-200" style="text-transform: none; font-family: 'Karma'; color: grey; padding-top: 2px; border-radius: 3px" tabindex="0">
    ...
    <script src="../required/js/app.js"></script>
		...
		<script type="text/javascript">
			$('.ui.special.card .content .description .img').dimmer({
				on: 'hover'
			});
		</script>
