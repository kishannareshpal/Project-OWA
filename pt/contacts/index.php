        ...
        <div class="mdl-grid" style="margin-bottom: 350px;">
          <div class="mdl-layout-spacer"></div>
            <div style="margin-top: 30px" class="mdl-cell mdl-cell--10-col">
              ...
              <h1 style="font-size: 40px; padding-left: 5px; text-shadow: 3px 3px rgba(180, 236, 192, 0.63);"><strong>Entre em Contacto</strong></h1>
                ...
                <div style="width: 100%" class="mdl-card__supporting-text">
                  ...
                  <div class="mdl-grid">
                    ...
                    <div class="mdl-cell mdl-cell--5-col mdl-cell--12-phone mdl-cell--12-col-tablet">
                      <h3><strong>Visite-nos!</strong></h3>
                      <!-- <div style="width: 100%" class="mdl-color-text--grey-500"> -->
                      <p style="margin-bottom: 0px"><strong>Endereço: </strong><u>1 Bairro Eduardo Mondlane, Maxixe - Moçambique</u>.<br>Estamos perto da Espansão!</p>
        ...
        <footer id="footer" hidden style="text-align: center; font-family: karma" class="mdl-mega-footer mdl-color--grey-50">
          ...
          <div class="mdl-mega-footer__bottom-section">
            ...
            <div class="mdl-grid" style="padding: 0px; margin-bottom: 22px;"> <!-- position: relative; bottom: 17px -->
              <div class="mdl-layout-spacer"></div>
              <a href="https://www.oneworldacademymz.com/contacts/" class="mdl-button mdl-js-button mdl-color--grey-200" style="text-transform: none; font-family: 'Karma'; color: grey; padding-top: 2px; border-radius: 3px" tabindex="0">
